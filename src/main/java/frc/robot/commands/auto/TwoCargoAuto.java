    ...
    public TwoCargoAuto(DriveBase drive, Intake intake, Transversal transversal, Uptake uptake, VarFlyWheel flywheel) {
        ...
        addCommands(
                ...
                sequence(
                        ...
                        // Run intake
                        new TeleIntake(intake, () -> -7.0)).withTimeout(10),

                // Auto Drive Sequence
                sequence(
                        // Put flywheel hood up
                        ...
                        // Shoot cargo
                        parallel(
                                new TeleFlyVar(flywheel).withTimeout(6),
                                new WaitCommand(1.0).andThen(new TeleFeed(transversal, uptake, () -> 9.0))
                                        .withTimeout(5))));
    }
}
