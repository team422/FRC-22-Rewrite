...
public class FourCargoAutoPos3 extends ParallelCommandGroup {
    private static final double DRIVE_SPEED = 0.4;
    private static final double TURN_SPEED = 0.5;

    public FourCargoAutoPos3(DriveBase drive, Intake intake, Transversal transversal, Uptake uptake,
        ...
        addCommands(
                ...
                sequence(
                        ...
                        new RunFlyWheel(flywheel, 2150, true).withTimeout(7),

                        // No need to run flywheel in this interim time
                        new WaitCommand(2),

                        // Run flywheel for final two shots
                        new RunFlyWheel(flywheel, 2000, true)),
                ...
                sequence(
                        ...
                        new Turn(drive, 83, TURN_SPEED * 0.5),

                        // Drive to loading station
                        new DriveStraightToBall(drive, intakeVision, Units.feetToMeters(20), DRIVE_SPEED * 1.8),
                        ...
                        // Turn to hub
                        new FastTurn(drive, -50, TURN_SPEED * 3),
